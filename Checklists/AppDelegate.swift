...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        guard let ListVC = NavVC.viewControllers.first as? ChecklistViewController else{return}
        ...
        do{
            ...
            let jsonData = try? jsonEncoder.encode(ListVC.items)
            
            try? jsonData?.write(to: itemsURL, options: .atomicWrite)
        }
        catch{
            print(error)
        }
